        ...
        <section id="contact" class="contact">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <h3 class="sub-title">{{ __('Details Kontak') }}</h3>
                        <div class="info">
                            @if(Helper::GeneralSiteSettings("contact_t1_" . @Helper::currentLanguage()->code) !="")
                                <div class="address">
                                    <i class="bi bi-geo-alt"></i>
                                    <h4>{{ __('Alamat Faperta UGJ') }}:</h4>
                                    <p><a href="https://maps.app.goo.gl/BBeJmCggrgbtScZq9">{{ Helper::GeneralSiteSettings("contact_t1_" . @Helper::currentLanguage()->code) }}<a/></p>
                                </div>
                            @endif
                            @if(Helper::GeneralSiteSettings("contact_t3") !="")
                                <div class="phone">
                                    ...
                                    <p><a
                                    href="tel<span
                                            dir="ltr">{{ Helper::GeneralSiteSettings("contact_t3") }}</a></span></p>
                                </div>
                            @endif
                    ...
                    <div class="col-lg-8 mt-5 mt-lg-0" id="contact-form-container">
                        <h3 class="sub-title">{{ __('Hubungi kami dengan mengisi formulir kontak di bawah ini.') }}</h3>
                        ...
                        <div>
                            <button type="submit" id="contactFormSubmit" class="btn btn-lg btn-theme"><i
                                    class="fa-solid fa-paper-plane"></i> {{ __('Kirim Pesan') }}</button>
                        </div>
                        {{Form::close()}}
