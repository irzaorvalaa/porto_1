    ...
    <section id="gallery" class="gallery">
        <div class="container">
            ...
            <div class="section-title">
                <h2>{{ __('Fasilitas Fakultas Pertanian UGJ') }}</h2>
                <h4>{{ __('Menjelajahi Fasilitas Unggulan: Sarana Terkini di Fakultas Pertanian UGJ') }}</h4>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="more-btn">
                        <a href="/photos" class="btn btn-theme"><i
