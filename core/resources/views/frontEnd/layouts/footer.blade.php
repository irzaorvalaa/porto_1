                ...
                <div class="row">
                    ...
                    <div class="col-lg-{{ $contacts_cols }} col-md-12 footer-links">
                        <div class="footer-title">
                            <h1>{{ __('Details Kontak') }}</h1>
                        </div>
                        @if(Helper::GeneralSiteSettings("contact_t1_" . @Helper::currentLanguage()->code) !="")
                            <address>
                                <strong>{{ __('frontend.address') }}</strong><br>
                                <i class="bi bi-geo-alt"></i>
                                <a href="https://maps.app.goo.gl/BBeJmCggrgbtScZq9">&nbsp;{{ Helper::GeneralSiteSettings("contact_t1_" . @Helper::currentLanguage()->code) }}</a>
                            </address>
                        @endif
