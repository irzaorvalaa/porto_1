                            ...
                            <ul class="list m-b-0">
                                <li class="list-item">
                                    ...
                                    <div class="clear">
                                        ...
                                        <p class="text-muted m-b-0">{!! $details !!}.. <a href="{{ route("topicsEdit",["webmasterId"=>$Topic->webmaster_id,"id"=>$Topic->id]) }}"><strong>[ {{ __("backend.viewDetails") }} ]</strong></a></p>
                                        <a href="{{ route('topics',$Topic->webmaster_id) }}" class="btn btn-xs light dk b-a m-t-sm">{!! $section  !!}</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
